...
static struct SpecialPreset SpecialObjectPresets[] = 
{
    ...
    {0x03, SPTYPE_NO_YROT_OR_PARAMS , 0x00, 0xB8, bhvStaticObject},
    {0x04, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_BOO, bhvBooGroup},
    {0x05, SPTYPE_NO_YROT_OR_PARAMS , 0x00, 0xAC, bhvCastleFloorTrap},
    ...
    {0x7C, SPTYPE_NO_YROT_OR_PARAMS , 0x00, 0x1A, bhvTree},
    {0x7D, SPTYPE_NO_YROT_OR_PARAMS , 0x00, MODEL_SSL_PALM_TREE, bhvTree},
    {0x89, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_CASTLE_CASTLE_DOOR2, bhvDoor},
    {0x7E, SPTYPE_YROT_NO_PARAMS    , 0x00, MODEL_CASTLE_WOODEN_DOOR2, bhvDoor},
    {0x7F, SPTYPE_YROT_NO_PARAMS    , 0x00, 0x1E, bhvDoor},
    ...
    {0x82, SPTYPE_YROT_NO_PARAMS    , 0x00, 0x21, bhvDoor},
    ...
    {0x84, SPTYPE_PARAMS_AND_YROT   , 0x00, 0x28, bhvDoorWarp},
    {0x85, SPTYPE_PARAMS_AND_YROT   , 0x00, MODEL_CASTLE_METAL_DOOR, bhvDoorWarp},
    {0x86, SPTYPE_PARAMS_AND_YROT   , 0x00, 0x2A, bhvDoorWarp},
    {0x87, SPTYPE_PARAMS_AND_YROT   , 0x00, 0x2B, bhvDoorWarp},
